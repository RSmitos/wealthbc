    ...
    <div className="min-h-screen bg-black">
      <div className="max-w-[1400px] mx-auto px-6 py-12">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-sm text-[#E3E3E3]">Average response time: 24 hours</p>
        </div>

        {/* 2. Search Bar (Hero Style) */}
        <div className="max-w-3xl mx-auto mb-12">
          <div className="relative">
            <Search className="absolute left-4 top-1/2 transform -translate-y-1/2 w-6 h-6 text-[#E3E3E3]" />
            <input
              type="text"
              placeholder="Search for help articles, FAQs, or tools..."
              value={searchQuery}
              onChange={(e) => setSearchQuery(e.target.value)}
              className="w-full pl-14 pr-6 py-5 bg-gradient-to-br from-[#1a1a1a] to-[#0a0a0a] border border-[#D4AF37]/20 rounded-xl text-white text-lg placeholder-gray-500 focus:border-[#D4AF37] focus:outline-none"
            />
          </div>
        </div>
                    ...
                    {category.articles.map((article, idx) => (
                      <details key={idx} className="bg-gradient-to-br from-[#1a1a1a] to-[#0a0a0a] border border-[#D4AF37]/20 rounded-xl overflow-hidden group">
                        <summary className="p-4 cursor-pointer hover:bg-white/5 transition-all text-white font-medium flex items-center justify-between">
                          ...
                          <ChevronDown className="w-5 h-5 text-[#E3E3E3] group-open:rotate-180 transition-transform" />
                        </summary>
                        <div className="px-4 pb-4 text-[#E3E3E3] border-t border-white/10 pt-4">
                          {article.content}
                        </div>
                      </details>
                    ))}
          ...
          <div className="space-y-6 lg:sticky lg:top-24 lg:self-start">
            ...
            <div id="ticket" className="bg-gradient-to-br from-[#1a1a1a] to-[#0a0a0a] border-2 border-[#D4AF37] rounded-xl p-6">
              ...
              <div className="space-y-3">
                ...
                <button className="w-full text-center text-[#E3E3E3] hover:text-[#D4AF37] transition-colors text-sm font-medium">
            ...
            <div className="bg-gradient-to-br from-[#1a1a1a] to-[#0a0a0a] border border-[#D4AF37]/20 rounded-xl p-6">
              ...
              <p className="text-sm text-[#E3E3E3] mb-4">
                Join the WealthBC community and get help from fellow members
              </p>
              <div className="space-y-2">
                <a href="#" className="flex items-center justify-between p-3 bg-white/5 rounded-lg hover:bg-white/10 transition-all">
                  ...
                  <ExternalLink className="w-4 h-4 text-[#E3E3E3]" />
                </a>
                <a href="#" className="flex items-center justify-between p-3 bg-white/5 rounded-lg hover:bg-white/10 transition-all">
                  <div className="flex items-center gap-2">
        ...
        <footer className="border-t border-[#D4AF37]/10 mt-20 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4 text-sm text-[#E3E3E3]">
            ...
            <div className="flex gap-6">
              ...
              <Link to={createPageUrl('Contact')} className="hover:text-[#D4AF37] transition-colors">Refund Policy</Link>
